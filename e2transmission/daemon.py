...
Changes:        23rd Jan 2009 (David Mytton <david@boxedice.com>)
                ...
                - Fixed unhandled exception if PID open is empty
'''
...
class Daemon(object):
    ...
    def daemonize(self):
        ...
        # Write pidfile
        atexit.register(
            self.delpid)  # Make sure pid open is removed if we quit
        pid = str(os.getpid())
    ...
    def stop(self):
        ...
        if not pid:
            ...
            # Just to be sure. A ValueError might occur if the PID open is
